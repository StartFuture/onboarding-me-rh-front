...
const WelcomeKit = () => {
  ...
  const getPaginatedKits = async (page) => {
    await api
      .get(`/getall-wk-paginated/?page=${page}`)
      ...
      <div className="container-page">
        ...
        <div className="container-search">
          ...
          <div
            ...
            style={{ display: kits.length > 0 ? "none" : "flex" }}
          >
            <img src={NoContent} alt="no content" />
            <span>
              Você não tem kits cadastrados. Cadastre clicando no botão abaixo.
            </span>
